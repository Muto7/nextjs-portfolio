    ...
    <>
      ...
      <div className="hidden md:fixed fixed md:left-24 md:top-7 md:block bg-gray-300 p-4 rounded-xl shadow">
        ...
        <div className="flex flex-col gap-6 mt-6">
          ...
          <NavItem href="#" icon="ri-file-list-3-line" label="Resume" />
          <NavItem href="#" icon="ri-briefcase-line" label="Portofolio" />
          <NavItem href="#" icon="ri-mail-line" label="Contact" />
        </div>
      </div>
      ...
      <div className="block md:hidden fixed bottom-0 left-1/2 transform -translate-x-1/2 bg-blue-500 text-white rounded-t-xl sm:rounded-xl w-full max-w-sm p-2 shadow-lg">
        <div className="flex justify-around py-2">
          ...
          <BottomNavItem href="#" icon="ri-file-list-3-line" label="Resume" />
          <BottomNavItem href="#" icon="ri-briefcase-line" label="Portfolio" />
          <BottomNavItem href="#" icon="ri-mail-line" label="Contact" />
        </div>
      </div>
    </>
  );
